...
<div class="container">   
  ...
  <div class="dropdown">
   <button class="dropbtn">Categories 
	...
	<div class="login"> 
		<center><p id="title1"> LOGIN  </p></center>
		<input type="text" name="name" placeholder="Enter Userid" id="uname" ></b><br><br>
		<input type="password" name="pass" placeholder="Password" id="pass">
		<input type="checkbox" onclick="myFunction()">
<font style="color:white;size:3px;"> Show Password</font>
<br><br>
...
try
{
	...
	if(name1!=null)
	{
			session.setAttribute("user1", name1);//THIS IS HOW WE DECLARE THE USER IN A SESSION
